...
export class OptimizerDetails extends React.Component {
    ...
    render() {
        const { brandList, geographyList, minimizeSpendValue, optimizationType, maximizeRevenueValue, periodValue, tacticValue, subBrandValue, showColumns, changeShowColumns, spendData, keyHighlights } = this.props
        const columns = [
                    ...
                    {record.newSpend && Math.round(record.newSpend) - Math.round(spend) != 0 ?
                        Math.round(record.newSpend) - Math.round(spend) > 0 ?
                            <div className="newSpend positive">
                                <div>${Math.round(Math.round(record.newSpend) - Math.round(spend)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                                <div>{Math.round((Math.round(Math.round(record.newSpend) - Math.round(spend))*100)/Math.round(spend))}%</div>
                            </div>
                            :
                ...
                <span>
                    ...
                    {record.newRevenue && Math.round(record.newRevenue) - Math.round(revenue) != 0 ?
                        Math.round(record.newRevenue) - Math.round(revenue) > 0 ?
                            <div className="newSpend positive">
                                <div>${Math.round(Math.round(record.newRevenue) - Math.round(revenue)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                                <div>{Math.round((Math.round(Math.round(record.newRevenue) - Math.round(revenue))*100)/Math.round(revenue))}%</div>
                            </div>
                            :
                            <div className="newSpend negitive">
                                <div>${Math.round(Math.round(record.newRevenue) - Math.round(revenue)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                ...
                <span>
                    ...
                    {record.newROI && parseFloat(record.newROI).toFixed(2) - parseFloat(roi).toFixed(2) != 0 ?
                        parseFloat(record.newROI).toFixed(2) - parseFloat(roi).toFixed(2) > 0 ?
                            <div className="newSpend positive">
                                <div>${parseFloat(parseFloat(record.newROI).toFixed(2) - parseFloat(roi).toFixed(2)).toFixed(2)}</div>
                                <div>{parseFloat((parseFloat(parseFloat(record.newROI).toFixed(2) - parseFloat(roi).toFixed(2)).toFixed(2)*100)/parseFloat(roi).toFixed(2)).toFixed(2)}%</div>
                            </div>
                            :
                            <div className="newSpend negitive">
                                <div>${parseFloat(parseFloat(record.newROI).toFixed(2) - parseFloat(roi).toFixed(2)).toFixed(2)}</div>
                        ...
                        }
                        {
                            ...
                            <div className="simulateHeader">
                                <h3 className="keyHeading">
                                    <Icon type="highlight" /> Spending Constraints
