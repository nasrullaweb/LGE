...
class Tab2 extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        //     region = {
        //         checkedList: state.regionValue,
        //         indeterminate: !!state.regionValue.length && state.regionValue.length < props.regionList.length,
        //         checkAll: state.regionValue.length === props.regionList.length,
        //     }
        // }
    ...
    //     sessionStorage.setItem('regionValueTab2', JSON.stringify(value));
    //     sessionStorage.removeItem('brandValueTab2');
    //     sessionStorage.removeItem('subBrandValueTab2');
    //     sessionStorage.removeItem('var2ValueTab2');
    //     sessionStorage.removeItem('var1ValueTab2');
    ...
    onBrandChange = (e) => {
        sessionStorage.setItem('brandValueTab2', JSON.stringify(e.target.value));
        sessionStorage.removeItem('subBrandValueTab2');
        sessionStorage.removeItem('var2ValueTab2');
        sessionStorage.removeItem('var1ValueTab2');
        this.setState({
    ...
    render() {
        ...
        //const regionMenu = this.setboxOption(regionList, 'region', this.onCheckAllRegionChange, this.onRegionChange, true, 'region')
        ...
        const var2Menu = this.setboxOption(inDepedentTactics, 'tactic', this.onCheckAllVar2Change, this.onVar2Change, true, 'var2')
        return (
            <div className="tabContent">
                ...
                <div className="FilterSelection">
                    ...
                    {/* {regionValue.length > 0 &&
                        <span>
                            Region: {
                            regionValue.map((item, index) =>
                            index === regionValue.length-1 ?
                            `${item} `
                            :
                            `${item}, `
                            )
